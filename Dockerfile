...
# Text Encoder: Gemma 3 12B (quantized Q4_0)
# Todos os arquivos do repositório são necessários
RUN if [ "$MODEL_TYPE" = "ltx-video" ]; then \
      ...
      wget --progress=dot:giga \
        https://huggingface.co/google/gemma-3-12b-it-qat-q4_0-unquantized/resolve/main/model-00001-of-00003.safetensors && \
      wget --progress=dot:giga \
        https://huggingface.co/google/gemma-3-12b-it-qat-q4_0-unquantized/resolve/main/model-00002-of-00003.safetensors && \
      wget --progress=dot:giga \
        https://huggingface.co/google/gemma-3-12b-it-qat-q4_0-unquantized/resolve/main/model-00003-of-00003.safetensors && \
      wget --progress=dot:giga \
